...
/**
 * Helper class for showing and canceling insulin notifications.
 * <p/>
 * This class makes heavy use of the {@link NotificationCompat.Builder} helper
 * class to create notifications in a backward-compatible way.
 */
public class InsulinNotification {
    /**
     * The unique identifier for this type of notification.
     */
    private static final String NOTIFICATION_TAG = "Insulin";
     ...
     * presentation of insulin notifications. Make sure to follow the <a
    ...
    public static void notify(final Context context,
        ...
        final String title = res.getString(
                R.string.insulin_notification_title_template, exampleString);
        final String text = res.getString(
                R.string.insulin_notification_placeholder_text_template,
                exampleString);
